...
export DEFAULT_GIT_REPO=https://github.com/Ektisad25/electron-novo
if [ -z "$GIT_REPO" ] ; then
...
export PACKAGE="Electron-Novo"  # Modify this if you like -- Windows, MacOS & Linux srcdist build scripts read this, while AppImage has it hard-coded
